...
export async function POST(request: NextRequest) {
  try {
    const { name, company, email, phone, industry, message } = await request.json()

    if (!name || !company || !email || !phone) {
      return NextResponse.json(
        { success: false, error: 'Name, company, email, and phone are required' },
        { status: 400 }
      )
    }
      ...
      <html>
        <head>
          ...
          <style>
            ...
            .message-box { background: white; padding: 15px; border-radius: 5px; border-left: 3px solid #06b6d4; margin-top: 10px; }
        ...
        <body>
          <div class="container">
            ...
            <div class="footer">
              <p>Submitted via the city page consultation form (FAQ section).</p>
...
Submitted via the city page consultation form.
    `.trim()

    console.log('📧 Sending consultation inquiry to:', ADMIN_EMAIL)

    await sendBrevoEmail({
      sender: { name: 'DBS Mintek Consultation Form', email: SENDER_EMAIL },
      ...
      <html>
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              <p>We have received your request for a <strong>free consultation</strong> with DBS Mintek.</p>
              <div class="highlight">
                <p style="margin: 0 0 8px 0;"><strong>What happens next?</strong></p>
                <p style="margin: 0;">A solutions architect will contact you within <strong>2 business hours</strong> to schedule your consultation.</p>
              </div>
              ...
              <p>If you have urgent questions, reply to this email or call our team directly.</p>
            </div>
            <div class="footer">
...
We have received your request for a free consultation with DBS Mintek.

What happens next?
A solutions architect will contact you within 2 business hours to schedule your consultation.
...
If you have urgent questions, reply to this email or call our team directly.
...
This is an automated confirmation.
    ...
    await sendBrevoEmail({
      ...
      to: [{ email, name }],
      subject: 'We received your consultation request - DBS Mintek',
    ...
    return NextResponse.json(
      { success: true, message: 'Your consultation request has been submitted successfully!' },
      { status: 200 }
    )
  } catch (error: unknown) {
