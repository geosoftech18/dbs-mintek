...
/** ISO 3166-1 alpha-2 countries with ITU-T E.164 dial codes */
export const countries: Country[] = [
  ...
  { iso: "TC", name: "Turks and Caicos", dial: "1" },
  ...
  { iso: "VG", name: "Virgin Islands (UK)", dial: "1" },
  { iso: "VI", name: "Virgin Islands (US)", dial: "1" },
